  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TABLE "roles"
                             (
                                 ...
                                 CONSTRAINT "UQ_894f1ce8f4cb35f97cb2b5e0f55" UNIQUE ("nome"),
    ...
    await queryRunner.query(`CREATE TABLE "filmes"
                             (
                                 "id"              uuid                   NOT NULL DEFAULT uuid_generate_v4(),
                                 ...
                                 "updated_at"      TIMESTAMP              NOT NULL DEFAULT now(),
                                 "deleted_at"      TIMESTAMP,
                                 CONSTRAINT "UQ_738ab432c6b1b1a937dc05b45f0" UNIQUE ("nome"),
                                 CONSTRAINT "PK_e7531027ca859ab4acb3a313658" PRIMARY KEY ("id")
                             )`);
    await queryRunner.query(`CREATE TABLE "avaliacoes"
                             (
                                 "filme_id"   uuid    NOT NULL,
                                 "usuario_id" uuid    NOT NULL,
                                 "nota"       integer NOT NULL,
                                 CONSTRAINT "PK_b2ee1a4fe50f931fc3e2f39dfda" PRIMARY KEY ("filme_id", "usuario_id")
                             )`);
    ...
    await queryRunner.query(`CREATE TABLE "categoria_filme"
                             (
                                 "filme_id"     uuid NOT NULL,
                                 "categoria_id" uuid NOT NULL,
                                 CONSTRAINT "PK_2e31ae5f95e4bb8019a799c31e3" PRIMARY KEY ("filme_id", "categoria_id")
                             )`);
    ...
    await queryRunner.query(`ALTER TABLE "avaliacoes"
        ADD CONSTRAINT "FK_dc384c9c1c97dd4571d46826577" FOREIGN KEY ("filme_id") REFERENCES "filmes" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    await queryRunner.query(`ALTER TABLE "avaliacoes"
        ADD CONSTRAINT "FK_66413181eb487cda3046f9c93b4" FOREIGN KEY ("usuario_id") REFERENCES "usuarios" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    await queryRunner.query(`ALTER TABLE "categoria_filme"
        ADD CONSTRAINT "FK_44cb9cc71b52bc1f98ab0147127" FOREIGN KEY ("filme_id") REFERENCES "filmes" ("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    await queryRunner.query(`ALTER TABLE "categoria_filme"
        ADD CONSTRAINT "FK_842de43d5c8fb46b05cfdf7a2be" FOREIGN KEY ("categoria_id") REFERENCES "categorias" ("id") ON DELETE CASCADE ON UPDATE CASCADE`);
